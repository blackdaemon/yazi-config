...
local function setup(_, options)
  ...
  if Yatline ~= nil then
    --ps.sub("cd", get_status)
    --ps.sub("tab", get_status)
    --ps.sub("rename", get_status)
    --ps.sub("bulk", get_status)
    --ps.sub("delete", get_status)
    --ps.sub("trash", get_status)
    --ps.sub("load", get_status)
